...
const carsData = [
  ...
  },
  {
    ...
    fields: {
      ...
      description:
        "The A6 Sedan features hallmark Audi design cues combined with intricate details to create an unmistakable presence. The beauty of the A6 Sedan can be seen not just in its design but also in its technology. With intelligent innovations and advanced driver assistance systems, the A6 is more. The strong and elegant exterior of the A6 Sedan needs an interior to match. Setting new class standards, the A6 Sedan delivers luxury and technology like never before.",
      extras: [
